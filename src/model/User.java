...
public class User {
    ...
    public User(int id, String username, String email, String password, RoleEnum role,
                String firstName, String lastName, String cnp, String phoneNumber) {
        this.id = id;
        this.username = username;
        this.email = email;
    ...
    public User(int id, String username, String email, String password, RoleEnum role,
                String firstName, String lastName, String cnp, String phoneNumber, SpecialtyEnum specialty, int workSchedule) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
