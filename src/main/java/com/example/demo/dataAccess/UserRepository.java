...
import com.example.demo.model.SpecialtyEnum;
...
public class UserRepository {
    ...
    public boolean saveUser(User user) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setString(9, user.getSpecialty());
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    User user = new User(
                            ...
                            rs.getString("cnp"),
                            rs.getString("phoneNumber"),
                            rs.getString("specialty") == null ? SpecialtyEnum.ONCOLOGIST.name() : rs.getString("specialty"),
